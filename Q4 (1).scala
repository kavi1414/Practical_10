object Q4{
  ...
  def main(args: Array[String]): Unit = {
    val account1 = new Account("Kavishka", 10000.0)
    val account2 = new Account("Yasanga", -5000.0)
    val account3 = new Account("Oshada", 20000.0)
    val account4 = new Account("Dasun", -20000.0)
